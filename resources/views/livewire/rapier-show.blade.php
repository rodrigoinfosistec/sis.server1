<x-layout.container>
    ...
    <x-layout.card.card-body-content-table-body-line-cell-action width="120">
        ...
        @if(App\Models\Report::where(['folder' => 'rapiermoviment', 'reference_1' => $item->id, 'reference_2' => Auth()->user()->company_id])->exists())
            <x-layout.card.card-body-content-table-body-line-cell-action-print-rapier-moviment :id="$item->id"/>
        @else
