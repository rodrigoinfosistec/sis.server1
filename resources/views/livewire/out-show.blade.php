...
<x-layout.card.card-body-content-table-body-line-cell-action width="80">
    @if(!$item->finished)
        <x-layout.card.card-body-content-table-body-line-cell-action-edit-out :id="$item->id"/>
    @else
        <x-layout.card.card-body-content-table-body-line-cell-action-detail :id="$item->id"/>

        <x-layout.card.card-body-content-table-body-line-cell-action-print-out :id="$item->id"/>
    @endif
