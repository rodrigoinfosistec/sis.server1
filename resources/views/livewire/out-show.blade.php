...
<x-layout.card.card-body-content-table-body-line-cell-action width="120">
    ...
    @else
        ...
        <a href="{{ asset('storage/pdf/out/' . @App\Models\Report::where(['folder' => 'out', 'reference_1' => $item->id, 'reference_2' => auth()->user()->company_id])->first()->file) }}" target="_blank" class="btn btn-link btn-sm" style="padding: 0px 5px 0px 5px;" title="PDF">
