...
<div class="table-responsive">
    @if(App\Models\Depositinputproduct::where('depositinput_id', $depositinput_id)->count() > 0)
    ...
    @else
        <div class="text-center text-muted fw-bold" style="width: 100%; margin-top: 50px; font-size: 13pt;">
