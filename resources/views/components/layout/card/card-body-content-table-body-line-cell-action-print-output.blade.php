<div class="dropdown float-end" style="width: 40px; padding-top: 6px; padding-left: 5px;">
    ...
    <ul class="dropdown-menu">
        @php
            $reports = App\Models\Report::where(['folder' => 'output', 'reference_1' => $id])->orderBy('id', 'DESC')->limit(20)->get();
        @endphp
        @foreach($reports as $key => $report)
    <li>
        <a class="dropdown-item" href="{{ asset('storage/pdf/output/' . $report->file) }}" target="_blank">
