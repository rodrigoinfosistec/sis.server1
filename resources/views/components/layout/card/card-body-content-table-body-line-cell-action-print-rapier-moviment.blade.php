<div class="dropdown float-end" style="width: 40px; padding-top: 6px; padding-left: 5px;">
    ...
    <ul class="dropdown-menu">
        @php
            $reports = App\Models\Report::where(['folder' => 'rapiermoviment', 'reference_1' => $id, 'reference_2' => Auth()->user()->company_id])->orderBy('id', 'DESC')->limit(20)->get();
        @endphp
        @foreach($reports as $key => $report)
    <li>
        <a class="dropdown-item" href="{{ asset('storage/pdf/rapiermoviment/' . $report->file) }}" target="_blank">
