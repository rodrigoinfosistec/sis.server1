...
class DepositinputShow extends Component
{
    ...
    public function render(){
        ...
        return view('livewire.' . $this->config['name'] . '-show', [
            'config'       => $this->config,
            'existsItem'   => Precencein::where('company_id', auth()->user()->company_id)->whereIn('deposit_id', $array)->exists(),
    ...
    public function addXml()
    {
        ...
        public function registerXml()
        {
            ...
            // Valida cadastro.
            $valid = Precencein::validateAddXml($data);
            ...
            // Cadastra.
            if ($valid) Precencein::addXml($data);

            // Executa dependências.
            if ($valid) Precencein::dependencyAddXml($data);
    ...
    {
        // Entrada Depósito.
        $depositinput = Precencein::find($depositinput_id);
    ...
    public function editItemAmount(int $depositinput_id)
    {
        ...
        public function modernizeItemAmount()
        {
            ...
            // Consolida a Entrada.
            Precencein::find($this->depositinput_id)->update([
                'funded' => true,
            ]);
    ...
    public function erase(int $depositinput_id)
    {
        ...
        public function exclude()
        {
            ...
            // Valida exclusão.
            $valid = Precencein::validateErase($data);

            // Executa dependências.
            if ($valid) Precencein::dependencyErase($data);

            // Exclui.
            if ($valid) Precencein::erase($data);
