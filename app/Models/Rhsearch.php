...
class Rhsearch extends Model
{
    ...
    public static function add(array $data) : bool {
        ...
        // After.
        $after = Rhsearch::where('name', Str::upper($data['validatedData']['name']))->first();

        // Auditoria.
        Audit::rhsearchAdd($data, $after);
    ...
    public static function edit(array $data) : bool {
        // Before.
        $before = Rhsearch::find($data['validatedData']['rhsearch_id']);

        // Atualiza.
        Rhsearch::find($data['validatedData']['rhsearch_id'])->update([
            'name'  => $data['validatedData']['name'],
            'link'  => $data['validatedData']['link'],
            'icon'  => $data['validatedData']['icon'],
            'color' => $data['validatedData']['color'],
        ...
        // After.
        $after = Rhsearch::find($data['validatedData']['rhsearch_id']);

        // Auditoria.
        Audit::rhsearchEdit($data, $before, $after);
    ...
    public static function erase(array $data) : bool {
        // Exclui.
        Rhsearch::find($data['validatedData']['rhsearch_id'])->delete();

        // Auditoria.
        Audit::rhsearchErase($data);
    ...
    public static function generate(array $data) : bool {
        ...
        // Gera o PDF.
        Report::rhsearchGenerate($data);

        // Auditoria.
        Audit::rhsearchGenerate($data);
    ...
    public static function mail(array $data) : bool {
        // Envia e-mail.
        Email::rhsearchMail($data);

        // Auditoria.
        Audit::rhsearchMail($data);
