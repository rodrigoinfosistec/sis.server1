...
class Activity extends Model
{
    ...
    public static function add(array $data) : bool {
        ...
        // After.
        $after = Activity::where('name', Str::upper($data['validatedData']['name']))->first();

        // Auditoria.
        Audit::activityAdd($data, $after);
    ...
    public static function validateEdit(array $data) : bool {
        ...
        // Atividade.
        $activity = Activity::find($data['validatedData']['activity_id']);
    ...
    public static function edit(array $data) : bool {
        // Before.
        $before = Activity::find($data['validatedData']['activity_id']);

        // Atualiza.
        Activity::find($data['validatedData']['activity_id'])->update([
            'name'   => Str::upper($data['validatedData']['name']),
            'status' => $data['validatedData']['status'],
        ]);

        // After.
        $after = Activity::find($data['validatedData']['activity_id']);

        // Auditoria.
        Audit::activityEdit($data, $before, $after);
    ...
    public static function erase(array $data) : bool {
        // Exclui.
        Activity::find($data['validatedData']['activity_id'])->delete();

        // Auditoria.
        Audit::activityErase($data);
    ...
    public static function generate(array $data) : bool {
        ...
        // Gera o PDF.
        Report::activityGenerate($data);

        // Auditoria.
        Audit::activityGenerate($data);
    ...
    public static function mail(array $data) : bool {
        // Envia e-mail.
        Email::activityMail($data);

        // Auditoria.
        Audit::activityMail($data);
