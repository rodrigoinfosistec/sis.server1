...
class Rhnews extends Model
{
    /**
     * Nome da tabela.
     */
    protected $table = 'rhnews';
    ...
    public static function add(array $data) : bool {
        ...
        // After.
        $after = Rhnews::where('name', Str::upper($data['validatedData']['name']))->first();

        // Auditoria.
        Audit::rhnewsAdd($data, $after);
    ...
    public static function edit(array $data) : bool {
        // Before.
        $before = Rhnews::find($data['validatedData']['rhnews_id']);
        ...
        // After.
        $after = Rhnews::find($data['validatedData']['rhnews_id']);

        // Auditoria.
        Audit::rhnewsEdit($data, $before, $after);
    ...
    public static function erase(array $data) : bool {
        // Exclui.
        Rhnews::find($data['validatedData']['rhnews_id'])->delete();

        // Auditoria.
        Audit::rhnewsErase($data);
    ...
    public static function generate(array $data) : bool {
        ...
        // Gera o PDF.
        Report::rhnewsGenerate($data);

        // Auditoria.
        Audit::rhnewsGenerate($data);
    ...
    public static function mail(array $data) : bool {
        // Envia e-mail.
        Email::rhnewsMail($data);

        // Auditoria.
        Audit::rhnewsMail($data);
