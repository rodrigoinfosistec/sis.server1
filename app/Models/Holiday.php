...
class Holiday extends Model
{
    ...
    public static function erase(array $data) : bool {
        // Exclui.
        Holiday::find($data['validatedData']['holiday_id'])->delete();

        // Auditoria.
        Audit::holidayErase($data);
    ...
    public static function generate(array $data) : bool {
        ...
        // Gera o PDF.
        Report::holidayGenerate($data);

        // Auditoria.
        Audit::holidayGenerate($data);
    ...
    public static function mail(array $data) : bool {
        // Envia e-mail.
        Email::holidayMail($data);

        // Auditoria.
        Audit::holidayMail($data);
