...
use App\Http\Controllers\EmployeedeclarationController;
...
Route::middleware([
    ...
    Route::get('/employeedeclaration', [EmployeedeclarationController::class, 'index'])->name('employeedeclaration');
